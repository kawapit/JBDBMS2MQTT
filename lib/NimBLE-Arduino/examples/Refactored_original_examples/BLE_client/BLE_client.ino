...
static BLEAdvertisedDevice *bmsDevice;

static void notifyCallback(BLERemoteCharacteristic *pBLERemoteCharacteristic, uint8_t *pData, size_t length, bool isNotify)
{
  Serial.print("Notify callback for characteristic "); Serial.print(pBLERemoteCharacteristic->getUUID().toString().c_str());
  Serial.print(" of data length "); Serial.println(length);
  Serial.print("data: "); Serial.println((char*)pData);
}
...
{
  Serial.print("Forming a connection to "); Serial.println(bmsDevice->getAddress().toString().c_str());
...
*******************************************************************/
	  bmsDevice = advertisedDevice; /** Just save the reference now, no need to copy the object */
	  doConnect = true;
	  doScan = true;
	} // Found our server
  } // onResult
